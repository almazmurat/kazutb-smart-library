...
| Public | Discover | Project A / Academic Discovery Hub | `/discover` | `discover.blade.php` | pending — **Cluster A** | Phase 3 Cluster A.2. Existing surface; needs export-backed refinement. Scope enrichment: add knowledge-map layer (Cluster E) as secondary discovery axis under UDC. |
