    ...
    <div class="container">
      ...
      <div class="feature-grid teacher-grid">
        <div class="feature-card">
          ...
          <p>Собирайте книги из каталога в подборку — черновик списка литературы для учебной дисциплины. Копируйте готовый список в документ одним нажатием.</p>
          <a href="/shortlist" class="feature-link">Моя подборка →</a>
        </div>
    ...
    <div class="container">
      ...
      <div class="syllabus-steps">
        ...
        <div class="step-card">
          ...
          <p>Добавляйте найденные книги в <a href="/shortlist">подборку литературы</a>. Из каталога и страниц книг нажимайте «В подборку» — все выбранные издания соберутся в один список.</p>
        </div>
