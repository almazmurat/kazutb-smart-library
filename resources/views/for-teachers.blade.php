    ...
    <div class="container">
      ...
      <div class="feature-grid teacher-grid">
        <div class="feature-card" style="border: 2px solid var(--violet, #7c3aed); background: linear-gradient(135deg, rgba(124,58,237,.03), rgba(124,58,237,.08));">
          ...
          <p>Собирайте книги и электронные ресурсы в подборку — черновик списка литературы. Выберите формат, скопируйте текст или распечатайте готовый список для вставки в силлабус.</p>
    ...
    <div class="container">
      ...
      <div class="syllabus-steps">
        ...
        <div class="step-card">
          ...
          <p>Добавляйте найденные книги и электронные ресурсы в <a href="/shortlist">подборку литературы</a>. Из каталога и страниц книг нажимайте «В подборку» — все выбранные источники соберутся в один список.</p>
        </div>
