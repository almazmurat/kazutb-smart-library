...
@section('title', 'О библиотеке — Digital Library')
...
@section('content')
  <section class="page-hero">
    <div class="container">
      ...
      <p>Digital Library — центр знаний и информационной поддержки для студентов, преподавателей и исследователей.</p>
    </div>
  </section>
    ...
    <div class="container about-grid">
      <div>
        ...
        <p class="text-body" style="margin: 0 0 20px;">
          Digital Library обеспечивает информационную поддержку учебы и исследований. Наша задача — предоставить каждому пользователю удобный и полный доступ к учебной, научной и справочной литературе.
        </p>
