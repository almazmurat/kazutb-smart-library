export const en = {
  ...
  dqWorkbenchSummaryReviewed: "Reviewed",
  ...
  dqWorkbenchSafetyReadonlyLegacy:
    "Reviewer actions are persisted in the Smart Library staging layer only. Legacy MARC source records are not modified.",
  dqIssueFieldLabel: "Field",
  dqIssueRuleLabel: "Rule",
  dqReviewStatusLabel: "Review Status",
  dqReviewDecisionNoteLabel: "Decision Note (optional)",
  dqReviewDecisionNotePlaceholder:
    "Add rationale for status change (kept in review audit trail).",
  dqReviewNewNoteLabel: "Add Reviewer Note",
  dqReviewNewNotePlaceholder: "Add contextual note for librarian review.",
  dqAssignmentLabel: "Assign to User ID",
  dqAssignmentPlaceholder: "UUID of assignee (optional)",
  dqActionUpdateStatus: "Update Review Status",
  dqActionAddNote: "Add Note",
  dqActionAssignIssue: "Assign Issue",
  dqReviewNotesTitle: "Review Notes",
  dqReviewNotesEmpty: "No notes added for this issue yet.",
  dqReviewStatusOPEN: "Open",
  dqReviewStatusIN_REVIEW: "In Review",
  dqReviewStatusNEEDS_METADATA_COMPLETION: "Needs Metadata Completion",
  dqReviewStatusDUPLICATE_CANDIDATE: "Duplicate Candidate",
  dqReviewStatusESCALATED: "Escalated",
  dqReviewStatusREVIEWED: "Reviewed",
  dqFilterAll: "All",
  dqStageRaw: "Raw",
  dqStageClean: "Clean",
