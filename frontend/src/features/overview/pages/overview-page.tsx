    ...
    <div className="app-page">
      ...
      >
        <p className="text-sm leading-7 text-slate-600">
          Основные сценарии: поиск книги, просмотр карточки, проверка наличия
          по филиалам, работа читателя в кабинете, обработка задач
          библиотекарем, административный и аналитический контроль.
        </p>
      </PageIntro>
